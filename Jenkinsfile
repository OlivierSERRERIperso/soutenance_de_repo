   ...
   steps {
                script {
                    sh'''
                     ...
                     mysql -h localhost -u root -proot -e "LOAD DATA INFILE '/var/lib/mysql/info_company.csv' IGNORE INTO TABLE info_company FIELDS TERMINATED BY ',' ENCLOSED BY '\"' LINES TERMINATED BY '\\n' IGNORE 1 ROWS;"
                    '''
                }
            }
